...
const CommunicationHistoryParent = ({ route, navigation }) => {
  ...
  useEffect(() => {
    let url = serverIP.concat("/operations/retrieve_sms_history/", userID, "/");
    axios
      .get(url)
...
export default CommunicationHistoryParent;