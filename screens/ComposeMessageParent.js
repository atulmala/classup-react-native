    ...
    return (
      <View>
        <Text style={styles.headerText}>Compose Message</Text>
          ...
          <Text style={styles.headerText2}>{category}</Text>
      </View>
    );
  };
      ...
      [
        ...
        },
        {
          text: "OK", onPress: () => {
            ...
            formData.append("communication_text", message);
            ...
            try {
              axios.post(serverIP.concat("/parents/submit_parents_communication1/"), formData)
                .then(function (response) {
                  ...
                  Alert.alert(
                    "Messages Sent",
                    "If necessary, School Authorities will get in touch with you. Thanks",
                    [
                      {
                        text: "OK", onPress: () => {
